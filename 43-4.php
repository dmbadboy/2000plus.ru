...
<form action="43-4.php" method="post">
<p>
Домино:<input type="text" name="eng1" value="<?=@$eng1?>"/>
</p>
<p>
Шашки:<input type="text" name="eng2" value="<?=@$eng2?>"/>
</p>
<p>
<p>
Лото:<input type="text" name="eng3" value="<?=@$eng3?>"/>
</p>
Рулетка:<input type="text" name="eng4" value="<?=@$eng4?>"/>
</p>
<p>
Чемпионат:<input type="text" name="eng5" value="<?=@$eng5?>"/>
</p>
<p>
Тренировка:<input type="text" name="eng6" value="<?=@$eng6?>"/>
</p>
<p>
<p>
Соревнование:<input type="text" name="eng7" value="<?=@$eng7?>"/>
</p>
<p>
